  ...
  begin
    ...
    begin
        ...
        case (current_state)
            ...
            DONE_STATE  : if (mode_sync2 && !direction_sync2) next_state = DESTINATION1; else if (mode_sync2 && direction_sync2) next_state = SOURCE1; else if (!BG_sync2) next_state = WAITING; else next_state = DONE_STATE;
    ...
    begin
        ...
        case (current_state)
            ...
            ACKNOWLEDGMENT  : IO_ack = 1; // Sending ack until we are sure the DMA continues

            DEST2_ACKNOWLEDGMENT    : IO_ack = 1;
